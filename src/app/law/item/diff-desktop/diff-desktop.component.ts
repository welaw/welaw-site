...
@Component({
    selector: 'app-law-item-diff-desktop',
    templateUrl: './diff-desktop.component.html',
    styleUrls: ['./diff-desktop.component.css']
})
export class LawItemDiffDesktopComponent implements OnInit, OnChanges {
