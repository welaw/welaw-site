...
@Component({
    selector: 'app-law-item-min-mobile',
    templateUrl: './min-mobile.component.html',
    styleUrls: ['./min-mobile.component.css']
})
export class LawItemMinMobileComponent implements OnInit, OnChanges {
    ...
    ngOnChanges(changes: SimpleChanges) {
        ...
        let c = <LawSet>changes.law.currentValue;
