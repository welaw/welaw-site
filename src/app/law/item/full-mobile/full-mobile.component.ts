...
@Component({
    selector: 'app-law-item-full-mobile',
    templateUrl: './full-mobile.component.html',
    styleUrls: ['./full-mobile.component.css']
})
export class LawItemFullMobileComponent implements OnInit, OnChanges {
